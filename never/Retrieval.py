...
def train(
    ...
    for i, (image, image_aug, text, idx) in enumerate(
...
def itm_eval(scores_i2t, scores_t2i, txt2img, img2txt):
    ...
    eval_result = {
        "txt_r1": round(tr1, 4),
        "txt_r5": round(tr5, 4),
        "txt_r10": round(tr10, 4),
        "txt_r_mean": round(tr_mean, 4),
        "img_r1": round(ir1, 4),
        "img_r5": round(ir5, 4),
        "img_r10": round(ir10, 4),
        "img_r_mean": round(ir_mean, 4),
...
def main(args, config):
    ...
    for epoch in range(0, max_epoch):
        ...
        if utils.is_main_process():
            ...
            print("test resulst: ", test_result)
