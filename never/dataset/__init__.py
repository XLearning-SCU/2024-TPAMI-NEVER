...
def create_dataset(dataset, config):
    ...
    if dataset == "pretrain":
        # arrow file (raw image) or json file (image path)
        if "arrow" in config["train_file"][0]:
            dataset = pretrain_dataset_arrow(config["train_file"], pretrain_transform)
        else:
